...
// eventsRepo provides repository access to sports.
type EventsRepo interface {
	// Init will initialise our sports repository.
	Init() error

	// List will return a list of sports.
	ListEvents(filter *sports.ListEventsRequestFilter) ([]*sports.Event, error)
}
...
func (r *eventsRepo) ListEvents(filter *sports.ListEventsRequestFilter) ([]*sports.Event, error) {
	var (
		err   error
		query string
		args  []interface{}
